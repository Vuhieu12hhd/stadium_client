...
function init_Home() {
    ...
    //scroll down
    $('.match-best__check').click(function (ev) {
        ev.preventDefault();
...
function init_BookingOne() {
    ...
    // var for booking;
                var match = $('.choosen-match'),
                    city = $('.choosen-city'),
                    date = $('.choosen-date'),
                    stadium = $('.choosen-stadium'),
                    time = $('.choosen-time');
	...
	//6. Choose variant proccess
                ...
                $('.time-select__item').click(function (){
                    ...
                    //data element init
                    var chooseStadium = $(this).parent().parent().find('.time-select__place').text(); 

                    //data element set
                    time.val(chooseTime);
                    stadium.val(chooseStadium);
                });
...
function init_MatchList () {
	...
	//5. Toggle function for additional content
                ...
                $('.match__show-btn').click(function (ev) {
                    ev.preventDefault();

                    $(this).parents('.match--preview').find('.time-select').slideToggle(500);
                });
...
function init_MatchPage () {
    ...
    //3. Slider item pop up
                ...
                $('.media-video .match__media-item').magnificPopup({
                    //disableOn: 700,
                    type: 'iframe',
                    mainClass: 'mfp-fade',
                    removalDelay: 160,
                ...
                $('.media-photo .match__media-item').magnificPopup({
                    type: 'image',
                    closeOnContentClick: true,
                    mainClass: 'mfp-fade',
                    image: {
                ...
                $('.match__media .swiper-slide').on('mousedown', function(e){
                    toggle = true;
    ...
    //8. Toggle between stadiums timetable and map with location
   	...
   	//9. Init map with several markers on.
                    ...
                    boxTextB.innerHTML = '<span class="pop_up_box_text">Empire Stadiums, 5-6 Leicester Square, London</span>';
                    ...
                    boxTextD.innerHTML = '<span class="pop_up_box_text">Odeon Stadium West End, Leicester Square, London</span>';
                    ...
                    boxTextE.innerHTML = '<span class="pop_up_box_text">Picturehouse Stadiums Ltd, Orange Street, London</span>';
...
function init_Stadium () {
    "use strict";

	//1. Swiper slider
				//init stadium sliders
                var mySwiper = new Swiper('.swiper-container',{
                    slidesPerView:8,
                    loop:true,
                  });
    ...
    //4. Init map
                    ...
                    var map = new google.maps.Map(document.getElementById('stadium-map'),mapOptions);
                    var marker = new google.maps.Marker({
                        map: map,
                        position: map.getCenter()
                    });
