      ...
      <div className='content-wrapper'>
        ...
        <section className='content'>
          <div className='container-fluid'>
            ...
            >
              <div className='modal-dialog' role='document'>
                <div className='modal-content'>
                  ...
                  <div className='modal-body'>Bạn muốn xóa lịch đấu này?</div>
            ...
            <p>Danh sách lịch đấu của toàn bộ hệ thống</p>
            {/* <c:foreach var="roomMatchSchedule" items="${roomMatchSchedules}"> */}
            {/* </c:foreach> */}
                    ...
                    <tr key={schedule.id}>
                      ...
                      <td>
                        ...
                        <button
                          ...
                          //   data-id='${roomMatchSchedule.id}'
                          className='btn btn-danger room-match-schedule-delete-action'
