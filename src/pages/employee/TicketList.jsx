    ...
    <div>
      ...
      <div className='container' style={{ marginTop: '50px' }}>
        ...
        {!receive ? (
          ticketInfo ? (
            <div className='col-xs-12 col-sm-12 col-md-4 well well-sm col-md-offset-4'>
              <h4 className='card-title'>{ticketInfo.match.toUpperCase()}</h4>
              ...
              <br />
              <span>Sân: {ticketInfo.stadium}</span>
              <br />
              <span>khán đài: {ticketInfo.room}</span>
              <br />
          ...
          <div className='col-xs-12 col-sm-12 col-md-6 well well-sm col-md-offset-3'>
            <div className='row'>
              ...
              <div className='col-sm-8'>
                <h1 style={{ textAlign: 'center' }}>VÉ VÀO SÂN</h1>
              </div>
              <div className='col-sm-4'>
                <h1 style={{ color: 'red' }}>K+ Sport</h1>
              </div>
            </div>
            <div className='row' style={{ textAlign: 'center' }}>
              <div className='col-sm-12'>
                <h4>CÔNG TY TNHH K+ Sport</h4>
                <h5>HÀ NỘI</h5>
                <br />
                <h2>{ticketInfo.match}</h2>
              </div>
            </div>
            <br />
            <div className='row'>
              ...
              <div className='col-sm-6'>
                <h3>
                  {moment(ticketInfo.premiere).add(ticketInfo.match_time,'minutes').format('HH:mm DD/MM/YYYY')}
                </h3>
              </div>
            </div>
            <div className='row'>
              ...
              <div className='col-sm-6'>
                <h2>SÂN: {ticketInfo.stadium}</h2>
                <h2>
                  KHÁN Đài: {ticketInfo.room} / {ticketInfo.position.join(', ')}
                </h2>
                {/* <h3>(Ghe/Rap)</h3> */}
                {/* <h4>Da thanh toan !</h4> */}
              </div>
            ...
            <hr />
            <h1 style={{ textAlign: 'center' }}>WWW.K+Sport.COM</h1>
          </div>
        )}
      </div>
      <Footer />
